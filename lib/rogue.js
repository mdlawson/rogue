(function() {
  var Animation, AssetManager, Entity, Game, GameLoop, KeyboardManager, Mouse, Rogue, RollingAverage, SpriteSheet, TileMap, ViewPort, c, find, gfx, log, math, util,
  ...
  Entity = (function() {
    ...
    Entity.prototype.update = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        func = _ref[_i];
        if (func != null) _results.push(func.call(this));
      }
      return _results;
    };
  ...
  c.sprite = (function() {
    ...
    sprite.prototype.draw = function() {
      ...
      if (util.isArray(f = this.scaleFactor)) c.scale(f[0], f[1]);
    ...
    sprite.prototype.scale = function(factor, pixel) {
      if (pixel) {
    ...
    sprite.prototype._recalculateImage = function() {
      var _ref, _ref2;
      if (this.width == null) {
        this.width = this.image.width * ((((_ref = this.scaleFactor) != null ? _ref[0] : void 0) != null) || 1);
      }
      if (this.height == null) {
        this.height = this.image.height * ((((_ref2 = this.scaleFactor) != null ? _ref2[1] : void 0) != null) || 1);
      }
  ...
  c.move = (function() {
    ...
    move.prototype.init = function() {
      this["import"](["sprite"]);
      if (this.dy == null) this.dy = 0;
      if (this.dx == null) this.dx = 0;
  ...
  c.collide = (function() {
    ...
    collide.prototype.init = function() {
      this["import"](["sprite"]);
      return this.updates[97] = this._colliding;
    };
  ...
  c.layer = (function(_super) {
    ...
    layer.prototype.draw = function(x, y) {
      ...
      r = math.round;
      if (!(x > 0 || y > 0)) {
        if (this.scrollX) this.x = math.round(rect.x * this.speed);
        if (this.scrollY) this.y = math.round(rect.y * this.speed);
      }
      c = this.parent.context;
      c.save();
      if (this.angle) c.rotate(this.angle * Math.PI / 180);
  ...
  c.gravity = (function() {
    ...
    gravity.prototype.init = function() {
      this["import"](["move"]);
      if (this.gravity == null) this.gravity = -10;
      return this.updates[96] = function() {
        if (this.dy > this.gravity) return this.dy -= 1;
      };
    };
