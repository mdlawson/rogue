(function() {
  var AssetManager, Entity, Game, GameLoop, KeyboardManager, Rogue, RollingAverage, TileMap, ViewPort, log, math, util,
  ...
  KeyboardManager = (function() {
    ...
    function KeyboardManager(context) {
      ...
      handleEvent = function(e) {
        ...
        if (_ref = e.keyCode, __indexOf.call(upFn, _ref) >= 0) fn[e.keyCode]();
  ...
  ViewPort = (function() {
    ...
    ViewPort.prototype.draw = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        entity = _ref[_i];
        if (this.visible(entity)) entity.draw();
      }
      this.context.restore();
      return this.context.strokeRect(this.x, this.y, this.width, this.height);
    };
    ...
    ViewPort.prototype.forceInside = function(entity, visible, buffer) {
      ...
      if (entity.x > h - buffer) return entity.y = h - buffer;
    };

    ViewPort.prototype.visible = function(entity) {
      return util.collide(entity, this);
    };
