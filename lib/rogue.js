(function() {
  ...
  c.move = (function() {
    ...
    move.prototype.init = function() {
      ...
      return this.updates[97] = function() {
  ...
  c.collide = (function() {
    ...
    collide.prototype.move = function(x, y) {
      ...
      while (this.colliding().length > 0) {
        ...
        if (y !== 0) {
          _results.push(y > 0 ? this.y-- : this.y++);
        } else {
  ...
  c.layer = (function(_super) {
    ...
    layer.prototype.draw = function(x, y) {
      ...
      r = math.round;
      if (!(x > 0 || y > 0)) {
        if (this.scrollX) this.x = rect.x * this.speed | 0;
        if (this.scrollY) this.y = rect.y * this.speed | 0;
      }
      c = this.parent.context;
      c.save();
      if (this.angle) c.rotate(this.angle * Math.PI / 180);
