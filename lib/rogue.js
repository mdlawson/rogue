...
(function() {
  var Animation, AssetManager, Entity, Game, GameLoop, KeyboardManager, Mouse, Rogue, RollingAverage, SpriteSheet, TileMap, Tween, ViewPort, b, c, collision, find, gfx, intergrate, log, math, physics, sqrt, util, v,
  ...
  GameLoop = (function() {
    ...
    GameLoop.prototype.loop = function() {
      ...
      this.dt = (this.currentTick - this.lastTick) || 0.01667;
      this.fps = this.averageFPS.add(1000 / this.dt);
      if (!(this.stopped || this.paused)) {
        _ref = this.call;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          func = _ref[_i];
          func.call(this.parent, this.dt / 100);
        }
      }
      if (!this.stopped) {
