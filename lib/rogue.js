(function() {
  ...
  c.sprite = {
    ...
    draw: function() {
      ...
      c.save();
      c.translate((this.x * this.res[0]) - this.xOffset, (this.y * this.res[1]) - this.yOffset);
  ...
  c.move = {
    init: function() {
      return util["import"](["sprite"], this);
    },
    move: function(x, y) {
      this.x += x;
      return this.y += y;
  ...
  GameLoop = (function() {
    ...
    function GameLoop() {
      this.loop = __bind(this.loop, this);      this.fps = 0;
