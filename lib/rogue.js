(function() {
  var Animation, AssetManager, Entity, Game, GameLoop, KeyboardManager, Mouse, Rogue, RollingAverage, SpriteSheet, TileMap, ViewPort, c, collision, find, gfx, log, math, util,
  ...
  AssetManager = (function() {
    ...
    AssetManager.prototype.get = function(src) {
      if (!(this[src] != null)) Rogue.log(2, "asset not loaded: " + src);
      return this[src];
    };
    ...
    AssetManager.prototype.load = function(src) {
      var asset, codec, ext, key, that, type, value, _ref;
      that = this;
      ext = src.split(".").pop();
      _ref = this.filetypes;
      for (key in _ref) {
      ...
      switch (type) {
        ...
        case "sound":
          ...
          if (!asset.canPlayType(codec)) return;
    ...
    collide.prototype.findCollisions = function() {
      ...
      for (_i = 0, _len = solid.length; _i < _len; _i++) {
        ...
        if (dir) {
          ...
          if (this.onHit != null) this.onHit(col);
          results.push(col);
        }
      }
  ...
  collision = {
    ...
    AABBhitmap: function(r, e) {
      var dir, p, _i, _j, _len, _len2, _ref;
      _ref = e.hitmap;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        dir = _ref[_i];
        for (_j = 0, _len2 = dir.length; _j < _len2; _j++) {
          p = dir[_j];
          if (this.hitTest([e.x + p[0], e.y + p[1]], r)) return true;
        }
      }
      return false;
    },
  ...
  GameLoop = (function() {
    ...
    GameLoop.prototype.loop = function() {
      ...
      if (this.showFPS) this.ctx.fillText(this.fps, 10, 10);
