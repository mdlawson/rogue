(function() {
  var AssetManager, Entity, Game, GameLoop, KeyboardManager, Rogue, RollingAverage, TileMap, ViewPort, c, e, find, log, math, util,
  ...
  c.drawable = {
    init: function() {
      ...
      return (_ref = this.yOffset) != null ? _ref : this.yOffset = math.round(this.image.height / 2);
    },
    draw: function() {
  ...
  find = function(c) {
    var ent, f, found, i, _i, _j, _len, _len2;
    found = [];
