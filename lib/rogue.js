...
(function() {
  ...
  collision = {
    ...
    createHitmap: function(img, res) {
      var ctx, data, hitmap, index, offset, pix, point, points, x, y, _i, _len;
      if (res == null) {
        res = [2, 2];
      }
      ...
      for (_i = 0, _len = points.length; _i < _len; _i++) {
        point = points[_i];
        if (point[0] >= math.round(img.width / 2)) {
          hitmap[1].push(point);
        } else {
          hitmap[3].push(point);
        }
        if (point[1] >= math.round(img.height / 2)) {
          hitmap[2].push(point);
        } else {
          hitmap[0].push(point);
        }
  ...
  c.hitmap = (function() {
    ...
    hitmap.prototype.collide = function(obj) {
      var dir, dir2, opoint, point, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1,
        _this = this;
      if (obj.forEach) {
        obj.forEach(function(o) {
          return _this.collide(o);
      ...
      if (obj.type === this.type && collision) {
        _ref = obj.hitmap;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          dir = _ref[_i];
          for (_j = 0, _len1 = dir.length; _j < _len1; _j++) {
            ...
            for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
              dir2 = _ref1[_k];
              for (_l = 0, _len3 = dir2.length; _l < _len3; _l++) {
                point = dir2[_l];
